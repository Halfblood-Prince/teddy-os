...
- draggable `Terminal` and `File Explorer` windows
...
- `kernelgfx` now includes PS/2 mouse input, a software cursor, desktop icons, taskbar buttons, and draggable GUI windows
